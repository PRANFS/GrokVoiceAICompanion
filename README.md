...
- **STT/TTS Mode (English-only)** - Moonshine English Medium Streaming STT -> Grok 4.3 (non-reasoning mode) -> Grok Streaming TTS
...
> 
> **STT/TTS Mode (English-only)** – Moonshine English Medium Streaming STT (free) → Grok 4.3 (non-reasoning mode) → Grok Streaming TTS  
...
> - Grok 4.3 (non-reasoning mode): **$1.25 / M input tokens** + **$2.50 / M output tokens**  
...
- **STT/TTS Mode (English-only)**:
   ...
   - Sends transcript text to `grok-4.3` with `reasoning_effort: "none"`.
